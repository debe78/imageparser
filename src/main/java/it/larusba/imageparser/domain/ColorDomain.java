...
public class ColorDomain 
{
	 ...
	 public ColorDomain(String name, int r, int g, int b)//Inizializzo i colori RGB e li converto da HEX a INT
	 {
		 this.r = r;
		 this.g = g;
		 this.b = b;
	 ...
	 public ArrayList<ColorDomain> initColorList()//Lista colori 
	 {
		 ...
		 colorList.add(new ColorDomain("Green",0x00,0x80,0x00));
	 ...
	 public String getColorName(int r, int g, int b)//Ritorno il nome del colore medio
	 {
